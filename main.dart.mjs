...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1348: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1489: (x0,x1,x2) => x0.open(x1,x2),
      _1490: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1491: x0 => x0.abort(),
      _1492: (x0,x1) => x0.send(x1),
      _1493: x0 => x0.send(),
      _1494: x0 => x0.getAllResponseHeaders(),
      _1495: () => new AbortController(),
      _1496: x0 => x0.abort(),
      _1497: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1498: (x0,x1) => globalThis.fetch(x0,x1),
      _1499: (x0,x1) => x0.get(x1),
      _1500: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1500(f,arguments.length,x0,x1,x2) }),
      _1501: (x0,x1) => x0.forEach(x1),
      _1502: x0 => x0.getReader(),
      ...
      _1515: (x0,x1) => x0.log(x1),
      _1517: (x0,x1) => x0.key(x1),
      _1526: (s, m) => {
        try {
      ...
      _1600: () => globalThis.window,
      _1605: (x0,x1) => { x0.height = x1 },
      _1607: (x0,x1) => { x0.width = x1 },
      _1610: x0 => x0.head,
      _1611: x0 => x0.classList,
      _1615: (x0,x1) => { x0.innerText = x1 },
      _1616: x0 => x0.style,
      _1618: x0 => x0.sheet,
      _1629: x0 => x0.offsetX,
      _1630: x0 => x0.offsetY,
      _1631: x0 => x0.button,
      _1683: x0 => x0.readyState,
      _1685: (x0,x1) => { x0.timeout = x1 },
      _1687: (x0,x1) => { x0.withCredentials = x1 },
      _1688: x0 => x0.upload,
      _1689: x0 => x0.responseURL,
      _1690: x0 => x0.status,
      _1691: x0 => x0.statusText,
      _1693: (x0,x1) => { x0.responseType = x1 },
      _1694: x0 => x0.response,
      _1706: x0 => x0.loaded,
      _1707: x0 => x0.total,
      _1754: (x0,x1) => { x0.draggable = x1 },
      _1770: x0 => x0.style,
      _2699: (x0,x1) => { x0.accept = x1 },
      _2713: x0 => x0.files,
      _2739: (x0,x1) => { x0.multiple = x1 },
      _2757: (x0,x1) => { x0.type = x1 },
      _3472: () => globalThis.window,
      _3534: x0 => x0.navigator,
      _3798: x0 => x0.localStorage,
      _3921: x0 => x0.userAgent,
      _4129: x0 => x0.length,
      _6074: x0 => x0.signal,
      _6135: x0 => x0.firstChild,
      _6146: () => globalThis.document,
      ...
      _8605: x0 => x0.headers,
      _8606: x0 => x0.body,
      _11010: (x0,x1) => { x0.display = x1 },
      _12232: x0 => x0.name,
      _12950: () => globalThis.console,
